...
class TestSaleOrder(TransactionCase):
    ...
    def test_001_add_product_in_saleorder(self):
        ...
        self.assertEquals(round(sale_order.total_weight, 2), 0, "The total weight wrong, sale_order without lines")
        self.assertEquals(round(sale_order.total_volumen, 2), 0, "The total volumen wrong, sale_order without lines")
        ...
        self.assertEquals(round(sale_order.total_volumen, 2), -1, "The total volumen not was correctly compute")
        # Line qty=0
